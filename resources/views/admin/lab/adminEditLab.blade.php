...
@section('content')
    <div class="ui container">
        <div class="ui raised segment">
            <form class="ui form" action="{{ route('RuangLab.update', $lab->id) }}" method="PUT">
                @csrf
                <div class="disabled field">
                    <label>Ruangan</label>
                    <input type="text" name="ruangan" placeholder="Ruangan" class="form-control" value="{{ $lab->ruangan }}">
                </div>
                <div class="field">
                    <label>Nama Ruangan</label>
                    <input type="text" name="nama_ruangan" placeholder="Nama Ruangan" class="form-control"
                        value="{{ $lab->nama_ruangan }}">
                </div>
                <div class="field">
